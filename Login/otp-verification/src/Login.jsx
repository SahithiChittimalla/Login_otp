  ...
  return (
    <div className="container d-flex justify-content-center align-items-center"  style={{ minHeight: '100vh' }}>
      <div className="card p-4 shadow w-100" style={{ maxWidth: '400px' }}>
        ...
        <input className="form-control mb-3" placeholder="+91..." value={phone} onChange={(e) => setPhone(e.target.value)} />
        ...
        {otpSent && (
          <>
            <input className="form-control mb-3" placeholder="OTP" value={otp} onChange={(e) => setOtp(e.target.value)} />
